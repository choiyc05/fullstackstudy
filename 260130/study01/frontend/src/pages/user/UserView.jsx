	...
	return (
		<div className="container mt-3">
				...
				<div className="d-flex">
					<div className="p-2 flex-fill">
						<div className="form-check">
							<input type="radio" className="form-check-input" id="radio1" name="gender" value="1" defaultChecked disabled />남성
			...
			<div className="d-flex">
				...
				<div className="p-2 flex-fill d-grid">
					<button type="button" onClick={()=>navigate("/user/useredit")} className="btn btn-primary">수정</button>
				</div>
				<div className="p-2 flex-fill d-grid">
					<button type="submit" onClick={()=>navigate("/")} className="btn btn-primary">탈퇴</button>
				</div>
			</div>
		</div>
	)
